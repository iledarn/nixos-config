  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        "CTRL ALT, A, workspace, 11"
        "CTRL ALT, B, workspace, 12"
        "CTRL ALT, C, workspace, 13"
        ...
        "CTRL SHIFT, A, movetoworkspace, 11"
        "CTRL SHIFT, B, movetoworkspace, 12"
        "CTRL SHIFT, C, movetoworkspace, 13"
      ];
