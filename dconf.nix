...
with lib.hm.gvariant; {
  dconf.settings = {
    ...
    "org/gnome/desktop/wm/keybindings" = {
      maximize = [];
      move-to-workspace-1 = ["<Ctrl><Shift>1" "<Ctrl><Shift>x"];
      move-to-workspace-10 = ["<Ctrl><Shift>g"];
      move-to-workspace-11 = ["<Ctrl><Shift>s"];
      move-to-workspace-12 = ["<Ctrl><Shift>o"];
      move-to-workspace-2 = ["<Ctrl><Shift>2" "<Ctrl><Shift>d"];
      move-to-workspace-3 = ["<Ctrl><Shift>3" "<Ctrl><Shift>f"];
      move-to-workspace-4 = ["<Ctrl><Shift>4" "<Ctrl><Shift>e"];
      move-to-workspace-5 = ["<Ctrl><Shift>5" "<Ctrl><Shift>w"];
      move-to-workspace-6 = ["<Ctrl><Shift>6" "<Ctrl><Shift>t"];
      move-to-workspace-7 = ["<Ctrl><Shift>7"];
      move-to-workspace-8 = ["<Ctrl><Shift>8" "<Ctrl><Shift>v"];
      move-to-workspace-9 = ["<Ctrl><Shift>9" "<Ctrl><Shift>k"];
      switch-to-workspace-1 = ["<Ctrl><Alt>1" "<Ctrl><Alt>x"];
